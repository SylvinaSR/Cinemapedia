...
MoviesDbResponse moviesDbResponseFromJson(String str) => MoviesDbResponse.fromJson(json.decode(str));

String moviesDbResponseToJson(MoviesDbResponse data) => json.encode(data.toJson());
